...
pdf(file = "FPS9.1.pdf", family = "Times", height = 14, width = 8.5)
...
forest.rma(FPS9RMA, slab = paste(FPS9$Author, FPS9$`Pub Year`), ilab = cbind(FPS9$ilab2, FPS9$ilab1), ilab.pos = 4, 
           ...
           cex = 0.65, rows = c(60:16, 10:5), ylim = c(-3, 103), cex.lab = 0.75, top = 42)
...
text(-1.6, c(61, 11), pos = 4, c("Human Studies", "Veterinary Studies"), font = 2, cex = 0.8)


text(-1.6, c(63), pos = 4, c("Subgroups/Author(s)"), font = 2, cex = 0.75)
text(1.545, c(64), pos = 4, c("Trait-"), font = 2, cex = 0.75)
text(1.545, c(63), pos = 4, c("Isolates"), font = 2, cex = 0.75)
